...
export default async function PeopleOverview({ params }: { params: Promise<{ workspaceSlug: string }> }) {
  ...
  const metrics: [string, number][] = [
    ...
    ['Joining', lifecycle.joining.length],
    ['On notice', lifecycle.leaving.length],
    ['Overdue tasks', lifecycle.overdueTasks],
    ['Documents expired', lifecycle.documentsExpired],
  ];
  return (
    <div className="lf-page-stack">
      <PageHeader
        ...
        description="Monitor workforce availability, attendance and pending requests."
