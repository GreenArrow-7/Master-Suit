...
export const GET = route(
  { module: 'accounts', productModule: 'SALES', action: 'VIEW', params },
  async ({ ctx, params }) => {
...
export const PATCH = route(
  { module: 'accounts', productModule: 'SALES', action: 'EDIT', params, body: patchBody, auditEvent: 'RECORD_UPDATED' },
...
export const DELETE = route(
  { module: 'accounts', productModule: 'SALES', action: 'DELETE', params, auditEvent: 'RECORD_DELETED' },
  async ({ ctx, params }) => {
