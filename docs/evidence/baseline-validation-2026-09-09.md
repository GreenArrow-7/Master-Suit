...
159 files, **2015 passed, 2 skipped, 0 failed**, 187s. The two skips are
pre-existing and are the same two CI reports on green runs. The totals are 23
tests above the 1992 recorded earlier this session, which is exactly the two
boundary suites added under SPEC-0008 (10 + 13).
